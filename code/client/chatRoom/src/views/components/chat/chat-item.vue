...
//            }, 5000);
          ...
          connection() {
            ...
            this.stompClient.connect(() => {
              this.stompClient.subscribe('/msg/normal', (msg) => { // 订阅服务端提供的某个topic
                console.log('广播成功')
                ...
                this.chatList.push(Object.assign({},msg,{type: 'other'}))
              })
            }, (err) => {
              // 连接发生错误时的处理函数
              console.log('失败')
              ...
              this.stompClient.subscribe('/msg/normal', (msg) => { // 订阅服务端提供的某个topic
                ...
                this.chatList.push(Object.assign({},val,{type: 'other'}))
              })
          ...
          sendMsg(msg,type){
            if(type=="mess"){
              this.stompClient.send("/server/sendNormalMsg",{},
                JSON.stringify(msg),
              )   //普通信息
            }
          },
