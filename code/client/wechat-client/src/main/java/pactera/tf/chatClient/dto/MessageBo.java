...
public class MessageBo {
	 ...
	 * 创建加好友消息
	 */
	public static MessageBo createAddFriendMsg(String receiveCode,String message) {
		MessageBo bo=new MessageBo(MessageType.ADDFRIEND_MSG, SYSTEM, receiveCode, "", message);
		return bo;
	}
